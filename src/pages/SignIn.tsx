          ...
          <CardContent className="space-y-6">
            ...
            <div className="bg-muted/30 rounded-lg p-4 space-y-2">
              ...
              <div className="flex flex-col gap-1 text-xs text-muted-foreground">
                <span>• Vous êtes freelance ? → <Link to="/freelance" className="text-primary hover:underline">Dashboard Freelance</Link></span>
                <span>• Vous êtes une entreprise ? → <Link to="/company" className="text-primary hover:underline">Dashboard Entreprise</Link></span>
              </div>
            </div>
