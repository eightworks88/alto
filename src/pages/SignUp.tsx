...
const SignUp = () => {
  const [userType, setUserType] = useState<'freelance' | 'company'>('freelance');
  ...
  const validateForm = () => {
    ...
    if (!formData.acceptTerms) newErrors.push('Vous devez accepter les conditions générales');
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="fullName">
                  {userType === 'freelance' ? 'Nom complet' : 'Nom de l\'entreprise'}
                </Label>
                <Input
                  id="fullName"
                  type="text"
                  placeholder={userType === 'freelance' ? 'John Doe' : 'Mon Entreprise SAS'}
              ...
              >
                Créer mon compte {userType === 'freelance' ? 'freelance' : 'entreprise'}
              </Button>
            </form>
