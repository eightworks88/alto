    ...
    <section className="py-24 px-6 bg-gradient-to-br from-primary via-primary/95 to-primary/90 text-primary-foreground relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-5xl text-center relative z-10">
        ...
        <div className="animate-fade-in-up animate-delay-200 flex flex-col sm:flex-row gap-6 justify-center items-center">
          <Button 
            size="lg" 
            className="text-lg px-10 py-4 bg-white text-primary hover:bg-white/90 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 font-semibold rounded-xl"
          >
          ...
          <Button 
            size="lg" 
            variant="outline" 
            className="text-lg px-10 py-4 border-2 border-white/30 text-white bg-transparent hover:bg-white/10 hover:border-white/50 transition-all duration-300 transform hover:scale-105 font-semibold rounded-xl backdrop-blur-sm"
          >
